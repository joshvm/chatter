...
public class UpdateProfileStatusMessageMapper implements MessageMapper<UpdateProfileStatusMessage> {

    @Override
    public UpdateProfileStatusMessage map(final Packet pkt){
        return new UpdateProfileStatusMessage(
