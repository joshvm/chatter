...
public class PunishmentMapper implements ResultSetMapper<Punishment> {

    @Override
    public Punishment map(final int index, final ResultSet rs, final StatementContext ctx) throws SQLException{
