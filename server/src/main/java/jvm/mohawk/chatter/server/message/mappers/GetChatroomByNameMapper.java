...
public class GetChatroomByNameMapper implements MessageMapper<SearchChatroomByName> {

    @Override
    public SearchChatroomByName map(final Packet pkt){
        return new SearchChatroomByName(
                Utils.timestamp(),
                pkt.readString()
        );
    }
