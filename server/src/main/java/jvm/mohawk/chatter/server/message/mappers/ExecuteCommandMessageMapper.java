...
public class ExecuteCommandMessageMapper implements MessageMapper<ExecuteCommandMessage> {

    @Override
    public ExecuteCommandMessage map(final Packet pkt){
        return new ExecuteCommandMessage(
                pkt.readString()
        );
    }
}
