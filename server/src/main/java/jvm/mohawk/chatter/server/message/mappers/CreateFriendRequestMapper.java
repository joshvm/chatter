...
public class CreateFriendRequestMapper implements MessageMapper<CreateFriendRequest> {

    @Override
    public CreateFriendRequest map(final Packet pkt){
        return new CreateFriendRequest(
                Utils.timestamp(),
                pkt.readInt()
        );
    }
