...
public class ClientSyncRemoveChatroomUserEventListener implements RemoveChatroomUserEventListener {

    @Override
    public void onEvent(final ChatterClient client, final RemoveChatroomUserEvent e){
        e.user().chatroom().users().remove(e.user());
    }
}
