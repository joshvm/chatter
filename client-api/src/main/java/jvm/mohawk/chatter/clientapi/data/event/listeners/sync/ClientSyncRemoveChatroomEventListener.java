...
public class ClientSyncRemoveChatroomEventListener implements RemoveChatroomEventListener {

    @Override
    public void onEvent(final ChatterClient client, final RemoveChatroomEvent e){
        client.chatroomManager().remove(e.chatroom());
    }
}
