...
public class JoinChatroom extends Request {

    private final Chatroom chatroom;

    public JoinChatroom(final Chatroom chatroom){
        super(RequestType.JOIN_CHATROOM);
    ...
    public Packet serialize(){
        return new Packet(Opcode.JOIN_CHATROOM)
