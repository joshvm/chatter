...
public class AddCommandMessageEventMapper implements EventMapper<AddCommandMessageEvent> {

    @Override
    public AddCommandMessageEvent map(final ChatterClient client, final Packet pkt){
        return new AddCommandMessageEvent(
                pkt.readString()
        );
    }
}
