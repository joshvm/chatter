...
public class LeaveChatroom extends Request {

    private final Chatroom chatroom;

    public LeaveChatroom(final Chatroom chatroom){
        super(RequestType.LEAVE_CHATROOM);
    ...
    public Packet serialize(){
        return new Packet(Opcode.LEAVE_CHATROOM)
