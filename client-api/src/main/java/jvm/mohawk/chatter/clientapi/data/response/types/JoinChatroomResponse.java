...
public class JoinChatroomResponse extends Response<JoinChatroomResponse.Code> {

    public enum Code implements Response.Code {

        CHATROOM_DOES_NOT_EXIST(1),
        ALREADY_IN_CHATROOM(2),
        BANNED(3),
        SUCCESS(100),
        ERROR(101),
        UNKNOWN(102);
    ...
    public JoinChatroomResponse(final Code code){
        super(RequestType.JOIN_CHATROOM, code);
    }
}
