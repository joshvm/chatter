...
public class CancelFriendRequestResponse extends Response<CancelFriendRequestResponse.Code> {

    public enum Code implements Response.Code {

        FRIEND_REQUEST_NOT_FOUND(1),
        NOT_REQUESTED_BY_CLIENT(2),
        SUCCESS(100),
        ERROR(101),
        UNKNOWN(102);
    ...
    public CancelFriendRequestResponse(final Code code){
        super(RequestType.CANCEL_FRIEND_REQUEST, code);
    }
}
